...
class BaseEnv(gym.Env):
    ...
    def _set_up(self,rl_config):
        ...
        self.pid = getattr(rl_config, 'pid', False)
    ...
    def _reward_parameter(self,rl_config):
        ...
        self.c = rl_config.c
        self.wS = getattr(rl_config, 'wS', getattr(rl_config, 'wSell', 0))
        self.cB = getattr(rl_config, 'cB', getattr(rl_config, 'wBuy', 0))
        self.wPV = rl_config.wPV
        self.wC = getattr(rl_config, 'wC', getattr(rl_config, 'wCO', 0))
...
if __name__ == '__main__':
    ...
    config = get_config()
    env1 = BaseEnv(config, flag='train')
