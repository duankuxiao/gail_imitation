...
def get_config():
    ...
    rc_parser.add_argument('--Ro', type=float, default=1.259751e+03, help='Ro')
    ...
    rc_parser.add_argument('--Ai', type=float, default=7.589300e+01, help='Ai')
    ...
    rc_parser.add_argument('--Av', type=float, default=1.110868e+04, help='Awall')
    rc_parser.add_argument('--battery_capacity', type=float, default=30000/6, help='Battery capacity  30000 / 6')
    rc_parser.add_argument('--charge_capacity', type=float, default=5000/6, help='Battery charge capacity  21000 / 6')
    rc_parser.add_argument('--discharge_capacity', type=float, default=5000/6, help='Battery discharge capacity  22000 / 6')
    ...
    parser.add_argument('--use_action', type=bool, default=True, help='use_action')
    ...
    parser.add_argument('--pid', action='store_true', default=False, help='use pid controller')
    ...
    parser.add_argument('--test_freq', type=int, default=1000, help='save frequency')
    ...
    parser.add_argument('--wS', type=float, default=0, help='wS')
    parser.add_argument('--cB', type=float, default=0, help='cB')
